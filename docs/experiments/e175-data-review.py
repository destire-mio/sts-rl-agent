...
def main(root):
    ...
    check_path = Path(__file__).with_name('e175-review.py')
    ...
    result = dict(status='complete_reviewed', experiment='E175', actual_afterstate_rows=len(data.rows),
