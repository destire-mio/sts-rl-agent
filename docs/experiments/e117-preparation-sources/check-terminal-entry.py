"""Check the unchanged twelve-stream helper on completed E116 evidence and corruption controls."""
...
assert proof['status'] == 'matched' and proof['differences'] == {} and proof['natural_actions'] == 965
