"""Check E119 live choices on E116's observed parent route, without new playouts."""
...
spec = importlib.util.spec_from_file_location('e118_probe_runtime', C / 'run_collections.py')
...
proof = {'status': 'passed', 'cases': items, 'engine_sha256': job['engine_sha256'],
         ...
         'limits': 'Observed E116 parent branch only, using two software-only zero-head models; not a complete counterfactual tree or E119 learning result.',
