...
def main():
    ...
    C = G.T.COLLECTOR
    spec = importlib.util.spec_from_file_location('e101d_probe_collector', C / 'run_collections.py')
    ...
    original_source = G.ROOT.parents[2] / 'ironclad-alignment/evidence/e99-development-parity-20260920-01/cohort.py'
    import ast
    ...
    write(P / 'completion-verification.json', {'status': 'passed', 'checks': checks,
        ...
        'limits': 'Software entry/selection/whole-route audit controls on the known E98 parent route with a zero-head fixture; no learned candidate or original cohort validation.',
