"""Check E124 live choices on E121's observed parent route, without new playouts."""
...
spec = importlib.util.spec_from_file_location('e123_probe_runtime', C / 'run_collections.py')
...
proof = {'status': 'passed', 'cases': items, 'engine_sha256': job['engine_sha256'],
         ...
         'limits': 'Observed E121 parent branch only, using two software-only zero-head models; not a complete counterfactual tree or E124 learning result.',
