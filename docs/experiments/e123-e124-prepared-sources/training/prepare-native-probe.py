...
R = Q.parents[1]
C = Q.parent / 'heart-e121-scale-joint-labels-20260920-01'
...
(P / 'plan.json').write_text(json.dumps({
    ...
    'scope': 'Two zero-head readout models on the one observed E121 parent relic/card path; use only its observed parent terminal, no counterfactual labels or complete-tree claim. Positive native choices plus wrong-expanded-relic/card expectation rejections. No MCTS or optimizer updates.'}, indent=2) + '\n')
