"""E124 fixed data-scale arms; never launch before complete registered inputs."""
import argparse
...
SOURCE = ROOT.parent / 'heart-e121-scale-source-refresh-20260920-01'
COLLECTOR = ROOT.parent / 'heart-e121-scale-joint-labels-20260920-01'
NEW = COLLECTOR / 'joint'
OUTPUT = ROOT / 'scale'
...
def load_inputs():
    ...
    spec = importlib.util.spec_from_file_location('registered_e123_gate', COLLECTOR / 'run_collections.py')
