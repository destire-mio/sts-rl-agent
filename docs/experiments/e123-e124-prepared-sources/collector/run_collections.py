#!/usr/bin/env python3
"""E123 continuation collection; learning is a separately frozen downstream stage."""
import argparse
...
def prepare_relic(root):
    ...
    write(dest / 'protocol.json', {**plan, 'experiment': 'E123R', 'source': str(source)})
...
def source_ready(root):
    ...
    assert sha(parity / 'turn_extras.py') == plan['bomb_combiner_sha256']
