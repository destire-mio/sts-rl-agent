"""Launch bounded terminal-category fitting after root data and input review."""
import argparse
...
def main(root, phase, owned):
    ...
    import heart_terminal_stage_value as I
    E = I.E
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e174_owned', launcher)
        ...
        outcome = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_terminal_stage_value.py'), phase, '--study', str(root)],
