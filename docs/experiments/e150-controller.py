"""Own frozen E150 matched parent-action prior."""
...
def main():
    ...
    import heart_parent_prior as F
    E=F.E;outcomes=[]
    try:
        ...
        spec=importlib.util.spec_from_file_location('e150_owned',launcher)
        ...
        commands=[('train','heart_parent_prior.py',[],plan['training_timeout_seconds'])]
