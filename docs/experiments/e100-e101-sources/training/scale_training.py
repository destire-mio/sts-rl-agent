"""E101 fixed data-scale arms; never launch before complete registered inputs."""
import argparse
...
SOURCE = ROOT.parent / 'heart-e98-scale-source-refresh-20260920-01'
COLLECTOR = ROOT.parent / 'heart-e98-scale-joint-labels-20260920-01'
NEW = COLLECTOR / 'joint'
OUTPUT = ROOT / 'scale'
...
def load_inputs():
    ...
    spec = importlib.util.spec_from_file_location('registered_e100_gate', COLLECTOR / 'run_collections.py')
