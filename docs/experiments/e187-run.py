"""Own the printed-cost relation value control."""
import argparse
...
def main(root, owned):
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e187_owned', launcher)
        ...
        result = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_cost_relations_value.py'), 'train', '--study', str(root)],
