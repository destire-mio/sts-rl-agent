...
def main(root, phase, owned):
    ...
    import heart_item_transfer as I
    E = I.E
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e168_owned', launcher)
        ...
        outcome = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_item_transfer.py'), phase, '--study', str(root)],
