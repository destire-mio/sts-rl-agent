...
def main(root, phase, owned):
    ...
    import heart_combat_pretraining as I
    E = I.E
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e164_owned', launcher)
        ...
        outcome = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_combat_pretraining.py'), phase, '--study', str(root)],
