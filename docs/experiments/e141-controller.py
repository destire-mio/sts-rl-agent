"""Own gated E141 trajectory-value training and native checks."""
...
def main():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e141_owned', launcher)
        ...
        for name, budget in [('train', plan['resources']['training_seconds']),
            ...
            result = owner.run_owned(directory, [sys.executable, '-u',
                str(STUDY/'program/heart_trajectory_value_training.py'), name, '--study', str(STUDY)],
