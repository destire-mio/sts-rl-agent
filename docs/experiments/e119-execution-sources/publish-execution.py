"""Publish only the prepared E119 execution wrapper and existing entry proof."""
...
(P / 'README.md').write_text(
    'Own-code snapshots for the local E119 execution wrapper. They require the registered E117/E118 evidence, '
    'E119 prepared runtime and existing owned-process helper. They are not standalone runners. '
...
report = {'experiment': 'E119-execution', 'status': 'preparation_complete',
...
path = D / 'e119-training-execution.json'
