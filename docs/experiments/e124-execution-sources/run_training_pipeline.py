"""Execute the frozen E124 recipe once, with owned workers and native cleanup."""
...
def owned_module():
    ...
    spec = importlib.util.spec_from_file_location('e123_owned_training_launcher', T.COLLECTOR / 'run_pipeline.py')
