"""Own the single bounded late-campfire collection phase."""
import argparse
...
def main(root, owned):
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e162_owned', launcher)
        ...
        result = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_late_campfire.py'), 'collect', '--study', str(root)],
