"""Launch one bounded owned phase; training needs root auxiliary-data review."""
import argparse
...
def main(root, phase, owned):
    ...
    import heart_parent_state_value as I
    E = I.E
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e169_owned', launcher)
        ...
        outcome = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_parent_state_value.py'), phase, '--study', str(root)],
