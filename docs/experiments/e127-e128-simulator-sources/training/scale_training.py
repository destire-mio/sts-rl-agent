"""E128 fixed data-scale arms; never launch before complete registered inputs."""
import argparse
...
def load_inputs():
    ...
    spec = importlib.util.spec_from_file_location('registered_e127_gate', COLLECTOR / 'run_collections.py')
