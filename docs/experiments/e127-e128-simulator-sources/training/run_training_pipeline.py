"""Execute the frozen E128 recipe once, with owned workers and simulator-only evidence."""
...
def owned_module():
    ...
    spec = importlib.util.spec_from_file_location('e127_owned_training_launcher', T.COLLECTOR / 'run_pipeline.py')
    ...
    try:
        ...
        for arm in G.ARMS:
            ...
            if not natural['passed']:
                ...
                continue
            transitions.append({'arm': arm, 'outcome': 'passed_simulator_natural_development',
                                'natural_games_started': True, 'original_started': False})
        ...
        result = {'status': 'complete', 'evidence_scope': 'simulator_only', 'original_alignment_required': False,
