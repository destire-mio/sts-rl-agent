"""Own frozen E154 fits and complete full-run policy validation."""
...
def main():
    ...
    import heart_offline_control as F
    E=F.E;outcomes=[]
    try:
        ...
        spec=importlib.util.spec_from_file_location('e154_owned',launcher)
        ...
        commands=[('train','heart_offline_control.py',['train'],plan['training_timeout_seconds']),
                  ('evaluate','heart_offline_control_evaluation.py',[],plan['evaluation_timeout_seconds']+120)]
