"""Own frozen E151 nested-family stopping."""
...
def main():
    ...
    import heart_nested_stopping as F
    E=F.E;outcomes=[]
    try:
        ...
        spec=importlib.util.spec_from_file_location('e151_owned',launcher)
        ...
        commands=[('train','heart_nested_stopping.py',[],plan['training_timeout_seconds'])]
