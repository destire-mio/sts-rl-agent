"""E105D natural paired development; original verification precedes selection."""
import argparse
...
def natural(arm):
    ...
    try:
        ...
        rows = H.run_jobs(folder, jobs, config, 'E105D_' + arm + '_natural', deadline, worker_fn=D.C.worker)
        ...
        repeated = H.run_jobs(folder, repeat_jobs, config, 'E105D_' + arm + '_winner_replans',
...
def prepare_original(arm):
    ...
    registration = {'experiment': 'E105P', 'arm': arm, 'source_runtime': str(source),
