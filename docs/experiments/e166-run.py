...
def main(root, phase, owned):
    ...
    import heart_structured_comparison as I
    E = I.E
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e166_owned', launcher)
        ...
        outcome = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_structured_comparison.py'), phase, '--study', str(root)],
