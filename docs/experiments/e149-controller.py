"""Own frozen E149 matched map ablation."""
...
def main():
    ...
    import heart_map_ablation as F
    E=F.E;outcomes=[]
    try:
        ...
        spec=importlib.util.spec_from_file_location('e149_owned',launcher)
        ...
        commands=[('train','heart_map_ablation.py',[],plan['training_timeout_seconds'])]
