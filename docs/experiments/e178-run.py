"""Launch bounded card-combat auxiliary fitting after root data and input review."""
import argparse
...
def main(root, phase, owned):
    ...
    import heart_card_combat_delta as I
    E = I.E
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e178_owned', launcher)
        ...
        outcome = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_card_combat_delta.py'), phase, '--study', str(root)],
