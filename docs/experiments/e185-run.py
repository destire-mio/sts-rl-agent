"""Own the empty-reward normalization training control."""
import argparse
...
def main(root, owned):
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('e185_owned', launcher)
        ...
        result = owner.run_owned(output, [sys.executable, '-u', str(root / 'program/heart_empty_reward_value.py'), 'train', '--study', str(root)],
