...
**Current development (September 20): E115 confirms a remaining Bomb-instance mismatch.** Double bombs against Nemesis Intangible deal 2 in the original game and 1 in the simulator. Controlled original sequences confirm the gap. E112 source collection is stopped; 1,818 complete files and six matched original routes are preserved, and E113/E114 training admission stays closed. E110/E111 scoped repairs remain recorded. No new model or unseen-win result; the 50% goal remains open. Long-job observations use 20-minute intervals, with confirmed faults handled when found. [Diagnostic](docs/experiments/e115-bomb-diagnostic.json), [current status](docs/ironclad-training-status.md).
