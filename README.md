...
**Current development (September 20): original-game alignment is paused by user request; E127/E128 train within the frozen E121 simulator.** E122 continues its 6,144-family source sampling with eight workers and 20-minute observations. The 19:11 Shanghai checkpoint saved 2,550 source files; the original-game job was stopped and its processes cleaned. The local study controller is running and will collect coupled relic/card continuations, fit the fixed 1,536-versus-4,608-family arms, and evaluate qualifying models after complete simulator source/replay proofs. No new labels or optimizer updates had run at this launch checkpoint. The unseen 50% goal remains open; results use simulator scope. [Study launch](docs/experiments/e127-e128-simulator-training-launch.json), [current status](docs/ironclad-training-status.md).
