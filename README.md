...
**Current development (September 20): E97 stopped before training after finding a Guardian HP/block difference in the original game.** Six development-winning routes matched 6,261 commands; the seventh differs after True Grit triggers Feel No Pain/Juggernaut: native Guardian 120HP/20block versus simulator 125HP/15block. The remaining 41 winning routes were not attempted. Sampling stopped with 2,485 source files preserved and its owned processes cleaned. No E97 continuation labels, optimizer updates or candidate games ran. The fixed data-scale study remains untested pending repair and source validation; its assigned roots cannot become final unseen acceptance. [Stopped attempt](docs/experiments/e97-source-stop-result.json), [registered study](docs/experiments/e97-independent-family-scale-protocol.json).
