...
**Current development (September 20): E97 is collecting 4,096 new natural families to test independent-data coverage.** The registered comparison uses 1,536 old versus 4,608 combined fit families, the same joint readout, fixed L2 and 1,000 Adam updates per arm. Source audits and original-game development-winner checks precede new continuation labels. The 4,096 roots were assigned before outcomes, disjoint from captured local history; they are training/development material, not final acceptance. No E97 model has been trained or adopted. [E97 protocol](docs/experiments/e97-independent-family-scale-protocol.json).
