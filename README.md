...
**Current development (September 20): E106 repairs the Unceasing Top state/RNG difference.** Queued shuffle, draw and on-draw effects finish before player input. All231 regression cases, nine original controls and the preselected full natural route pass;1,069 original commands match through the Heart at49HP, including persistent RNG,196 outside-NN choices and repeat planning. E103 remains stopped with4,013 saved sources; E104/E105 remain closed. E107 launched regeneration of the same6,144 assigned source families under the repaired engine, with eight workers. E108/E109 prepare the fixed joint relic/card data-scale study; label generation and fitting remain gated by source/original verification. No new model was trained; the data-scale hypothesis and50% unseen-win goal remain open. Long-job observations use20-minute intervals. [Repair evidence](sim_patch/alignment/e106-unceasing-top-report.json), [source protocol](docs/experiments/e107-source-refresh-protocol.json), [preserved source stop](docs/experiments/e103-source-stop-result.json), [current status](docs/ironclad-training-status.md).
