...
**Current development (September 20): E89 finished its joint relic/card experiment; no candidate passed the fixed adoption gate.** All 6,324 first-relic and 25,188 joint continuations passed simulator audits with zero execution faults. The three arms completed 27,000 cross-validation optimizer updates; the strongest joint result was 165/1,536 versus 155, with 43 added wins and 33 lost wins (paired exact p=0.3019). Final refit updates and natural candidate games are zero. E95 verifies that saved heads improve their fit families without transferring this gain to held-out families. The repaired E87 baseline remains 248/2,560 Heart wins; its 48 development-winning original routes matched in E88. These results do not establish exhaustive parity or unseen acceptance. The 50% goal remains open; see [current training status](docs/ironclad-training-status.md), [E89 result](docs/experiments/e89-joint-refresh-result.json) and [E95 diagnosis](docs/experiments/e95-readout-diagnosis-result.json).
