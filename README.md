...
**Current development (September 20): E102 repairs the Spot Weakness difference that stopped E99.** Writhing Mass's Wither is an attacking intent and now grants the card's Strength; Exploder's UNKNOWN explosion remains excluded. All seven focused groups and 221 regressions pass. E102 matches all 18 recorded native Spot Weakness boundaries and replans the preselected failure seed to a Heart victory. Its full original route matches 1,090 commands at 15HP, with terminal/RNG, 207 outside-NN choices and repeat-planning checks. E99 remains stopped at 2,390 saved source games; its original gate matched five routes before the sixth exposed this difference. E100/E101's prepared collectors and training gates remain closed. A new registration must regenerate the affected sources and labels under E102; the data-scale hypothesis and 50% unseen-win goal remain open. No new model was trained. E103 launched regeneration of the unchanged 6,144 assigned source families under E102, with eight workers and 20-minute progress checks. E104/E105 prepare the unchanged joint relic/card data-scale recipe against these new inputs; their execution remains gated by complete source, original-route and label audits. [Source-refresh protocol](docs/experiments/e103-source-refresh-protocol.json). [Repair evidence](sim_patch/alignment/e102-spot-weakness-report.json), [preserved E99 stop](docs/experiments/e99-source-stop-result.json), [current status](docs/ironclad-training-status.md).
