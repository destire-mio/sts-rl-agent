...
**Current development (September 20): original-game alignment is paused; E129 completes saved simulator audits before E127/E128 training.** E122 finished all 6,144 natural games and 625 winner replans. Its shared three-hour allowance expired during the final audit: 38 chunks passed, eight were interrupted and 146 had not started. At 21:30 Shanghai, the replacement audit controller and owned child were OS-verified running with a separate one-hour allowance. It reuses the saved games, winner replans and valid audit chunks, then enters the unchanged joint relic/card collection and 1,536-versus-4,608-family training recipes. The original failed exit and artifacts remain. New labels and optimizer updates were zero at this launch checkpoint; the unseen 50% goal remains open. Observe long jobs every 20 minutes. [Audit recovery](docs/experiments/e129-audit-recovery-launch.json), [current status](docs/ironclad-training-status.md).
