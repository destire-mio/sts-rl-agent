...
当前 A20 心脏策略采用 **E60（2026-09-18）**。同一批 1,024 个未见根种子，原局外策略为 **83/1,024（8.1055%）**，学习第一幕 Boss 遗物选择后为 **112/1,024（10.9375%）**；新增 40 胜、损失 11 胜，净增 29，配对精确 p=5.7038e-5。两组共享有界重规划战斗器，每次搜索 8,000／Boss ×3；整局搜索量增加 **0.69%**。
